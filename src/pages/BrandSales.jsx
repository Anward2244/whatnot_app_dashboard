    ...
    if (chartRef.current && !isLoading) {
      chartInstance.current = new Chart(chartRef.current, {
        ...
        options: { 
          ...
          scales: {
            y: { grid: { color: 'rgba(255, 255, 255, 0.05)', drawBorder: false }, ticks: { color: '#9ca3af', padding: 8 }, border: { display: false } },
            x: { grid: { display: false, drawBorder: false }, ticks: { color: '#9ca3af', padding: 8 }, border: { display: false } }
          },
          animation: {
            duration: 800,
            easing: 'easeOutQuart'
